    ...
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/chartjs-plugin-datalabels.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/moment.min.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/fullcalendar.min.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/datatables.min.js'); ?>"></script>
    ...
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/jquery.barrating.min.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/select2.full.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/nouislider.min.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/bootstrap-datepicker.js'); ?>"></script>
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/vendor/Sortable.js'); ?>"></script>
    ...
    <!--
    -->
    <script src="<?php echo base_url(THEME_PATH . 'assets/js/default.js'); ?>"></script>
